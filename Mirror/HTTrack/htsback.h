...
int back_index(httrackp * opt, struct_back * sback, const char *adr, const char *fil, const char *sav);
...
HTS_INLINE int back_exist(struct_back * sback, httrackp * opt, const char *adr, const char *fil, const char *sav);
int back_nsoc(const struct_back * sback);
int back_nsoc_overall(const struct_back * sback);
// MIRROR_ADAPTATION START - Add argument 'base_id'
int back_add(struct_back * sback, httrackp * opt, cache_back * cache, const char *adr, const char *fil, const char *save, const char *referer_adr, const char *referer_fil, int test, unsigned long base_id);
int back_add_if_not_exists(struct_back * sback, httrackp * opt, cache_back * cache, const char *adr, const char *fil, const char *save, const char *referer_adr, const char *referer_fil, int test, unsigned long base_id);
// MIRROR_ADAPTATION END - Add argument 'base_id'
