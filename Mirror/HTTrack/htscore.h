...
void usercommand(httrackp * opt, int exe, const char *cmd, const char *file, const char *adr, const char *fil, LLint size); // MIRROR_ADAPTATION : Added 'size' parameter
...
int backlinks_done(const struct_back * sback, lien_url ** liens, 
                   int lien_tot, int ptr, httrackp *opt); // MIRROR_ADAPTATION : Added 'opt' parameter
