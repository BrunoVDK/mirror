...
#define HTS_DEF_FWSTRUCT_htsoptstate
    ...
    struct htsoptstate {
        ...
        int _hts_in_mirror;
        char **_hts_addurl;
        unsigned long hts_addurl_identifier; // MIRROR_ADAPTATION - References identifier of ProjectURL that is being added (used in Project.m)
        int _hts_cancel;
...
#define HTS_DEF_FWSTRUCT_httrackp
    ...
    struct httrackp {
        ...
        // --- MIRROR_ADAPTATION START : Added stats that used to be global, to enable use of multiple engines at once
...
#define HTS_DEF_FWSTRUCT_lien_url
    ...
    struct lien_url {
        ...
        uint8_t parent;           // MIRROR_ADAPTATION : Parent references identifier of parent ProjectURL
    };
...
#define HTS_DEF_FWSTRUCT_lien_back
    ...
    struct lien_back {
        ...
        char magic;
#endif
        unsigned long base_id;                  // MIRROR_ADAPTATION : Reference to base link identifier
