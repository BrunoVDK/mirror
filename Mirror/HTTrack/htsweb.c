...
/* External modules */
#include "coucal.h" // MIRROR_ADAPTATION : Used to be .c file
#include "htsmd5.h" // MIRROR_ADAPTATION : Used to be .c file
#include "md5.h" // MIRROR_ADAPTATION : Used to be .c file
...
void __cdecl htsshow_filesave(t_hts_callbackarg * carg, httrackp * opt,
                              const char *file, const char *adr, const char *sav) {
}
