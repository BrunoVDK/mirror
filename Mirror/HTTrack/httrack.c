...
static void __cdecl htsshow_filesave(t_hts_callbackarg * carg, httrackp * opt,
                                     const char *file, const char *adr, const char *save, LLint size);  // MIRROR_ADAPTATION : Added 'adr', 'save' and 'size' parameters
...
static void __cdecl htsshow_filesave(t_hts_callbackarg * carg, httrackp * opt,
                                     const char *file, const char *adr, const char *save, LLint size) {  // MIRROR_ADAPTATION : Added 'adr', 'save' and 'size' arguments
}
static void __cdecl htsshow_filesave2(t_hts_callbackarg * carg, httrackp * opt,
                                      const char *adr, const char *fil,
                                      const char *save, int is_new,
